...
<a id="header-adp-github-headertag618"></a>
## Tables
...
A good Lisp tutorial must include Lisp code examples\. ADP defines some macros to print code blocks\: [adp\-github\:code\-block](/docs/scribble/reference.md#function-adp-github-code-block) and [adp\-github\:example](/docs/scribble/reference.md#function-adp-github-example)\. The first macro does not evaluate the code\. So\, for example if you write this\:
...
The macro [adp\-github\:code\-block](/docs/scribble/reference.md#function-adp-github-code-block) allows you to write non\-Lisp code as well\. It can receive\, optionally\, the language to be used\:
...
Description can be inserted with the functions [adp\-github\:function\-description](/docs/scribble/reference.md#function-adp-github-function-description)\, [adp\-github\:variable\-description](/docs/scribble/reference.md#function-adp-github-variable-description)\, [adp\-github\:class\-description](/docs/scribble/reference.md#function-adp-github-class-description)\, [adp\-github\:package\-description](/docs/scribble/reference.md#function-adp-github-package-description) and [adp\-github\:system\-description](/docs/scribble/reference.md#function-adp-github-system-description)\.

For example\, ADP\-GITHUB defines the function [adp\-github\:image](/docs/scribble/reference.md#function-adp-github-image) we\'ve seen before\. I we want a description of that function we need to write the following\:
...
The functions that inserts references are [adp\-github\:href](/docs/scribble/reference.md#function-adp-github-href)\, [adp\-github\:fref](/docs/scribble/reference.md#function-adp-github-fref)\, [adp\-github\:vref](/docs/scribble/reference.md#function-adp-github-vref)\, [adp\-github\:cref](/docs/scribble/reference.md#function-adp-github-cref)\, [adp\-github\:pref](/docs/scribble/reference.md#function-adp-github-pref) and [adp\-github\:sref](/docs/scribble/reference.md#function-adp-github-sref)\. They insert a reference to a header\, function\, variable\, class\, package and system respectively\.

The [adp\-github\:href](/docs/scribble/reference.md#function-adp-github-href) function is a bit different from the others\. It accepts a variable number of arguments\, and it should receive a keyword argument ``` :tag ```\.
...
[adp\-github\:image](/docs/scribble/reference.md#function-adp-github-image)
...
A system may export a ton of symbols\, maybe hundreds\. For that reason we need some way to insert descriptions automatically\. That is the job of glossaries\. We have glossaries of three types\: ``` functions ```\, ``` variables ``` and ``` classes ```\. They can be inserted with the functions [adp\-github\:function\-glossary](/docs/scribble/reference.md#function-adp-github-function-glossary)\, [adp\-github\:variable\-glossary](/docs/scribble/reference.md#function-adp-github-variable-glossary) and [adp\-github\:class\-glossary](/docs/scribble/reference.md#function-adp-github-class-glossary)\.

Each type of glossary will iterate over all the exported symbols looking for possible descriptions to insert\. For example\. the [adp\-github\:variable\-glossary](/docs/scribble/reference.md#function-adp-github-variable-glossary) will look for exported symbols that has a value associated with it\.
